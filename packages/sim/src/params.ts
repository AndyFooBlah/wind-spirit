...
export const TERRAIN: Record<Terrain, TerrainInfo> = {
  ...
  ocean:    { mpdWild: 0,  mpdPath: 0,  passable: false, water: true,  forage: false, cap: cap(0, 0, 450, 0, 0) },   // fished from the shore; 800 let a shore village of 50 live on wild food once every map had an ocean rim
};
